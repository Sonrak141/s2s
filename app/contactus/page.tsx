    ...
    <div>
      ...
      <div className='  '>
        ...
        >
          ...
          <div className='left-10 text-center absolute md:block hidden top-[34rem] mr-5 md:text-left md:w-2/4'>
            <div className='flex flex-row items-center text-sm justify-center md:justify-start'>
            ...
            <div className='text-sm flex flex-row items-center justify-center md:justify-start'>
            ...
            <div className='flex text-sm flex-row items-center justify-center md:justify-start'>
