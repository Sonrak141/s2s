...
function WhatWeDoMenu() {
    ...
    return (
        <div
            className="flex md:text-center text-md -mt-4 w-screen md:rounded-md  md:text-black flex-col md:flex-row items-center justify-around">
            ...
            <Link
                ...
                className="pt-2 pb-2 hover:text-[#940000] px-8 rounded-sm  mr-40"
            >
