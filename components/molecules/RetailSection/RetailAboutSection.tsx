        ...
        <div
            ...
            <div
                        ...
                        <div data-aos="fade-right" className="lg:max-w-lg">
                            ...
                            >
                                <img
                                    ...
                                    src="/Photography/Retail/ShoppingBags.jpeg.jpeg"
                                    alt="South2SouthLogistic"
                                />
                            </div>

                            <p className="mt-6 text-center md:text-left text-xl leading-8 text-gray-700 mr-5">
                                {spanish ? "Invertimos en marcas de retail con gran potencial en diversos países. Nuestra estrategia consiste en colaborar con estas marcas para ayudarlas a expandirse a nuevas regiones. Esto lo logramos representando sus intereses comerciales y utilizando nuestra experiencia en tendencias de mercado y diferencias culturales.\n" +
                                    "\n" +
                                    "Nuestro enfoque implica seleccionar cuidadosamente las mejores oportunidades de retail en cada región donde operamos. Al proporcionar nuestros recursos y conocimientos, asistimos a estas marcas en la ampliación de sus operaciones y en alcanzar un crecimiento sostenible.\n" : "We invest in retail brands with great potential across various countries. Our strategy is to collaborate with these brands and help them expand into new regions. We achieve this by representing their commercial interests and utilizing our expertise in market trends and cultural nuances. \n" +
                                    "\n" +
                                    "Our approach involves carefully selecting the best retail opportunities in each region where we operate. By providing our resources and expertise, we assist these brands in scaling their operations and achieving sustainable growth.\n"}
                ...
                >
                    <img
                        className="md:w-[48rem] max-w-2xl rounded-xl bg-gray-900 shadow-xl ring-gray-400/10 mb-10 "
                        src="/Photography/Retail/ShoppingBags.jpeg"
                        alt="South2SouthLogistic"
                    />
                </div>
...
export default RetailAboutSection;